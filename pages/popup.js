// Popup Script for Image Harvest V2.0
// Detect popup mode and apply popup-specific setup
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Also run on multiple delays to catch async rendering from sidepanel.js init()
