 ...
 */
export function canConvert(format) {
 ...
 */
export function convertImageFormat(imageUrl, targetFormat, quality = 0.92) {
 ...
 * @returns {Promise<{dataUrl: string, blob: Blob, format: string}>} 转换结果
 */
export function convertBlobFormat(blob, targetFormat, quality = 0.92) {
  return new Promise((resolve, reject) => {
    if (!canConvert(targetFormat)) {
      reject(new Error(`Unsupported target format: ${targetFormat}`));
      return;
