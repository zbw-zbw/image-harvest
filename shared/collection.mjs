 ...
 */
export function collectionInit() {
 ...
 */
export function collectionAdd(item) {
 ...
 */
export function collectionRemove(id) {
  return new Promise(async (resolve, reject) => {
    try {
      const database = await collectionInit();
      const transaction = database.transaction([STORE_NAME], 'readwrite');
 ...
 * @returns {Promise<boolean>}
 */
export function collectionUpdate(id, updates) {
  return new Promise(async (resolve, reject) => {
    try {
      const database = await collectionInit();
      const transaction = database.transaction([STORE_NAME], 'readwrite');
 ...
 */
export function collectionGetAll() {
  return new Promise(async (resolve, reject) => {
    try {
      const database = await collectionInit();
 ...
 */
export function collectionGetById(id) {
  return new Promise(async (resolve, reject) => {
    try {
      const database = await collectionInit();
      const transaction = database.transaction([STORE_NAME], 'readonly');
 ...
 * @returns {Promise<Array>}
 */
export function collectionSearch(query) {
  return new Promise(async (resolve, reject) => {
    try {
      const database = await collectionInit();
      const transaction = database.transaction([STORE_NAME], 'readonly');
