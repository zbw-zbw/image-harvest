// Constants for Image Harvest extension
...
var SUPPORTED_FORMATS = ['jpg', 'jpeg', 'png', 'webp', 'gif', 'svg', 'bmp', 'ico', 'avif'];
...
// License & Payment
var LICENSE_API_URL = 'https://image-harvest.kyriewen.cn/api/license';
var PRICING_PAGE_URL = 'https://image-harvest.kyriewen.cn/pricing';
var PRICING = {
  MONTHLY: 2.99,
  YEARLY: 19.99,
  LIFETIME: 39.99
...
var LICENSE_CHECK_INTERVAL = 24 * 60 * 60 * 1000; // 24 hours
var LICENSE_GRACE_PERIOD = 7 * 24 * 60 * 60 * 1000; // 7 days offline grace
var MAX_LICENSE_INSTANCES = 1;
