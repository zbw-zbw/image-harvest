...
/**
 * 感知哈希（pHash）算法实现
 * 纯前端 Canvas API，不使用 import/export
 */

// Use var instead of const/let to allow re-injection without "already declared" errors
 ...
 */
function calculatePHash(imageUrl) {
