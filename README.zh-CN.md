...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/零追踪-Zero%20Tracking-success" alt="零追踪">
...
| **终身版** | $39.99 | 一次性付费          | 一次买断，永久使用 —— 无订阅烦恼    |
...
- **支持邮箱**：[coderkyriewen@gmail.com](mailto:coderkyriewen@gmail.com)
...
`website/` 目录是 Image Harvest 的官方营销站，基于 [Next.js](https://nextjs.org) 构建，承载着陆页、定价、常见问题以及 License 激活入口。开发说明详见 [website/README.md](./website/README.md)。
...
**最新版本**：`v1.0.0` —— 🎉 首个公开版本，已上架 Chrome Web Store。
