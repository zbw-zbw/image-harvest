...
| ---------------------------------- | ------- | ---------- | ------------------------------------- |
| All-files aggregate Lines          | _n/a_   | **72.73%** | new metric + 2 sweeps                 |
...
| Vitest test cases                  | 847     | **1,090**  | +243                                  |

#### Verified

- `npm run typecheck` ✅
- `npm run lint` ✅
- `npx prettier --check` ✅ (4 format-fixed in the Stage-1 touched set)
- `npm test` → **44 files / 1,090 cases** ✅
- `npm run test:coverage` → `All files` Lines **72.73%** ✅ (see hotspot table above)
- `npx playwright test e2e/smoke.e2e.ts` → **3/3** ✅ (4.3s)
