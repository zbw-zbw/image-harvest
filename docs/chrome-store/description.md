...
> 用于 Chrome Web Store 商品详情页的完整描述文案（英文）。提交时直接复制粘贴到 "Detailed description" 字段。
...
- Multi-tab batch extract
- Similar image detection (pHash)
- Full color extraction + HEX copy
- Reverse search (4 engines)
- Batch highlight & auto-scroll
...
Works on Chrome 88+. Built with Manifest V3.
...
[https://image-harvest.kyriewen.cn](https://image-harvest.kyriewen.cn)
